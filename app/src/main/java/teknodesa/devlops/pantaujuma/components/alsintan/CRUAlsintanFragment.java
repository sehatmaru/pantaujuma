...
public class CRUAlsintanFragment extends Fragment {
    FragmentActivity activity;

    DetailLahanFragment detailLahanFragment;
    AlamatFragment alamatFragment;
    CRUAlsintanFragment.ViewPagerAdapter adapter;
    ...
    private void setViewpager() {
        ...
        adapter = new CRUAlsintanFragment.ViewPagerAdapter(getActivity().getSupportFragmentManager());
