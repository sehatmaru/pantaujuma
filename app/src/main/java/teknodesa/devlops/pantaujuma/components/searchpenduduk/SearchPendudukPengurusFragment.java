...
public class SearchPendudukPengurusFragment extends DialogFragment implements FragmentPendudukAdapter.OnClickPendudukListener {
    ...
    public SearchPendudukPengurusFragment() {

    }

    public static SearchPendudukPengurusFragment newInstance(OnClickPendudukListener onClicPenduduks) {
        SearchPendudukPengurusFragment.onClicPenduduk = onClicPenduduks;
        SearchPendudukPengurusFragment fragment = new SearchPendudukPengurusFragment();
    ...
    public void OnClickPenduduk(String idPenduduk, String namaDepan, String namaBelakang, String nik) {
        onClicPenduduk.OnClickPenduduk(keterangan, idPenduduk, namaDepan, namaBelakang, nik);
        dismiss();
    }

    public interface OnClickPendudukListener {
        void OnClickPenduduk(int keterangan, String idPenduduk, String namaDepan, String namaBelakang, String nik);
    }
}
