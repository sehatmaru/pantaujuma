...
public class PengurusPoktanRepository implements PoktanContract.Repository<PengurusPoktanRealm> {
    @Inject
    Realm realm;

    private PoktanContract.Controller mController;

    public PengurusPoktanRepository(PoktanContract.Controller mController, @NonNull AppComponent appComponent) {
    ...
    public void deleteItem(String idItem) {
        ...
        final RealmResults<PengurusPoktanRealm> results = realm.where(PengurusPoktanRealm.class).equalTo("hashId", idItem).findAll();
    ...
    public void setItemDeleted(String idItem) {
        ...
        PengurusPoktanRealm deletedItem = realm.where(PengurusPoktanRealm.class).equalTo("hashId", idItem).findFirst();
    }
}
