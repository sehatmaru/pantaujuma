...
public class AlsintanPupukAdapter extends RecyclerView.Adapter<AlsintanPupukAdapter.MyViewHolder> {
    ...
    public AlsintanPupukAdapter(Context context, List<PupukRealm> listData, OnClickPupukListener onClicPupuk) {
        mContext =context;
    ...
    @Override
    public void onBindViewHolder(AlsintanPupukAdapter.MyViewHolder holder, int position) {
