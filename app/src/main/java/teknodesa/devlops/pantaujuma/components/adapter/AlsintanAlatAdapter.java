...
public class AlsintanAlatAdapter extends RecyclerView.Adapter<AlsintanAlatAdapter.MyViewHolder> {
    ...
    public AlsintanAlatAdapter(Context context, List<PupukRealm> listData, OnClickPupukListener onClicPupuk) {
        mContext =context;
    ...
    @Override
    public void onBindViewHolder(AlsintanAlatAdapter.MyViewHolder holder, int position) {
