...
public class AnggotaPoktanController implements PoktanContract.Controller<AnggotaPoktanRealm> {
    ...
    PoktanContract.Repository<AnggotaPoktanRealm> mRepository;

    public AnggotaPoktanController(PoktanContract.View mView, @NonNull AppComponent appComponent){
        appComponent.inject(this);
        this.mView = mView;
        this.mRepository = new AnggotaPoktanRepository(this, appComponent);
    }
