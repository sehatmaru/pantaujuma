...
public class RKTPController implements RKTPContract.Controller<RKTPRealm> {
    @Inject
    Realm realm;

    RKTPContract.View mView;
    RKTPContract.Repository<RKTPRealm> mRepository;

    public RKTPController(RKTPContract.View mView, @NonNull AppComponent appComponent){
        appComponent.inject(this);
        this.mView = mView;
        this.mRepository = new RKTPRepository(this, appComponent);
    }
