...
public class CRUKomoditasFragment extends Fragment {
    FragmentActivity activity;

    DetailLahanFragment detailLahanFragment;
    AlamatFragment alamatFragment;
    CRUKomoditasFragment.ViewPagerAdapter adapter;
    ...
    private void setViewpager() {
        ...
        adapter = new CRUKomoditasFragment.ViewPagerAdapter(getActivity().getSupportFragmentManager());
