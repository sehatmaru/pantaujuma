...
public class SearchKomoditasFragment extends DialogFragment implements FragmentKomoditasAdapter.OnClickKomoditasListener {
    ...
    public SearchKomoditasFragment() {

    }

    public static SearchKomoditasFragment newInstance(OnClickKomoditasListener onClicKomoditass) {
        SearchKomoditasFragment.onClicKomoditas = onClicKomoditass;
        SearchKomoditasFragment fragment = new SearchKomoditasFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View v = getActivity().getLayoutInflater().inflate(R.layout.layouts_komoditas, null);
        ...
        recyclerView = (RecyclerView) v.findViewById(R.id.recyclerViewListKomoditas);

        searchViewListKomoditas = (SearchView) v.findViewById(R.id.searchViewListKomoditas);
    ...
    private void populateInitialData() {
        realm.executeTransactionAsync(realm1 -> {
            listtarget = realm1.copyFromRealm(realm1.where(KomoditasRealm.class).findAll().sort("nama", Sort.ASCENDING));
        }, () -> {
    ...
    public void OnClickKomoditas(String idKomoditas, String nama, String deskripsi) {
        onClicKomoditas.OnClickKomoditas(idKomoditas, nama, deskripsi);
        dismiss();
    }
