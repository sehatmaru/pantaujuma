...
public class FragmentPendudukAdapter extends RecyclerView.Adapter<FragmentPendudukAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.content_search_penduduk, parent, false);
    ...
    public void onBindViewHolder(FragmentPendudukAdapter.MyViewHolder holder, int position) {
        ...
        holder.cardview.setOnClickListener(view -> { onClicPenduduk.OnClickPenduduk(penduduk.getHashId(),penduduk.getNamaDepan(), penduduk.getNamaBelakang(), penduduk.getNIK());});
    }
