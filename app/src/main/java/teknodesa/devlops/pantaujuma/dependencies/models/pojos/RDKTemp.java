...
public class RDKTemp {
    private String idRDK;
    private int idDesa;
    ...
    public String getIdRDK() {
        return idRDK;
    }

    public void setIdRDK(String idRDK) {
        this.idRDK = idRDK;
    }
